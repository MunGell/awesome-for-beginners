...
- Make sure your contribution is useful and relevant before submitting. That implies it has 
...
- Check your spelling and grammar in the desired file.
...
- If the label does not clearly state it's "beginner friendly" purpose, please make sure to confirm with the maintainer that it is used for such issues. Please include the link to where the maintainer approves it in the PR. See examples below:
  - Repository called "HornsAndHoovesJs" has label `good-first-contribution`. This PR does
   not need to be confirmed with the maintainer and can be merged straight away.
...
- Maintainer confirmation is also required in case repository . It has more than one beginner-friendly-like label (e.g. `low-hanging-fruit` and `up-for-grabs`).

...
- Make sure your contribution is useful and relevant before submitting. This implies that it has enough content and every item has a good succinct description.
...
- Maintainer confirmation is also required in case repository that has more than one beginner-friendly-like label (e.g. `low-hanging-fruit` and `up-for-grabs`).

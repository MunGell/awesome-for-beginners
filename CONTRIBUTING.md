...
- Search from the previous suggestions before making a new one, as yours may be a duplicate.
...
- Make sure that your text editor is set to remove trailing whitespace.

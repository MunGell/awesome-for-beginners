...
- [Fireproof](https://github.com/fireproof-storage) _(label: good-first-issue)_ <br> Zero dependency, offline-capable CRDT database, runs in the browser and connects to any cloud

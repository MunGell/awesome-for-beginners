...
- [FileShot.io](https://github.com/nicholasgriffintn/FileShot.io) _(label: good first issue)_ <br> A Node.js and vanilla JS file sharing server with a clean codebase and no framework complexity. Good beginner issues include UI improvements, documentation, and testing.

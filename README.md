...
- [First Contributions](https://github.com/firstcontributions/first-contributions) _(label: good first issue)_<br>To make first contribution 
...
- [ImprovedTube](https://github.com/code-charity/youtube) _(label: good first issue)_ <br> A powerful but lightweight extension, to enrich your video experience & enable your content selection.
- [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) – Popular repo of JS algorithms with many doc-only improvements. _(label: good first issue)_<br> beginner friendly for learning javascript

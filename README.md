...
- [Reset Windows Update Tool](https://github.com/ManuelGil/Reset-Windows-Update-Tool/labels/help%20wanted) _(label: help wanted)_ <br> Troubleshooting for Windows Update.

...
- [Crawler Detect](https://github.com/JayBizzle/Crawler-Detect/labels/good%20first%20issue) _(label: good first issue)_ <br> CrawlerDetect is a PHP class for detecting bots/crawlers/spiders via the user agent

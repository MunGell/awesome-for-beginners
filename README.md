...
- [Simple-Python-codes](https://github.com/tasnimzotder/hactoberfest-2020) _(label: good first issue)_ <br> A repository for beginners to start with creating PR through their knowledge based on Python and Html.

...
- [tree-sitter-legesher-python](https://github.com/legesher/tree-sitter-legesher-python) _(label: good-first-issue)_ <br> This software uses the written language interchangeable version of the tree-sitter grammar for Python, allowing the user to write Python code in their native language.

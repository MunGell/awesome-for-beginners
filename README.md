...
- [Akri](https://github.com/deislabs/akri/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) _(label: good first issue)_ <br> Akri is a Kubernetes extention that discovers IoT devices around k8s clusters and automatically deploys applications.

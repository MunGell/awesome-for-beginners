...
- [Hash Checker](https://github.com/fartem/hash-checker/labels/good%20first%20issue) _(label: good first issue)_ <br> Fast and simple Android application for generating and comparison hashes from files or text.

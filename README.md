...
- [Pytest](https://github.com/pytest-dev/pytest/issues?q=is%3Aopen+is%3Aissue+label%3Aeasy) _(label: easy)_ <br> The pytest framework makes it easy to write small tests, yet scales to support complex functional testing.

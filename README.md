...
- [DenseMole](https://github.com/kra268/DenseMole) _(label: good first issue)_ <br> Purely python module started for substituting functional groups in molecules for automated Gaussian calculations.

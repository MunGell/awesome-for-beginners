...
- [password-generator](https://github.com/iamprakash13/password-generator/labels/good%20first%20issue) _(label: good first issue)_ <br> simple script to generate random strong passwords in python.

...
- [SaltStack](https://github.com/saltstack/salt/labels/Low-Hanging%20Fruit) _(label:"Low-Hanging Fruit")_ <br> Configuration management software and remote execution engine.

...
- [QuickPerf](https://github.com/quick-perf/quickperf/issues?q=is%3Aissue+is%3Aopen+label%3A%22%3Athumbsup%3A+good+first+issue%22) _(label: good first issue)_ <br> QuickPerf is a testing library for Java providing annotations to quickly evaluate some performance properties.
- [Maven test bench](https://github.com/quick-perf/maven-test-bench/issues?q=is%3Aissue+is%3Aopen+label%3A"%3Athumbsup%3A+good+first+issue") _(label: good first issue)_ <br> Performance test bench for Apache Maven projet.

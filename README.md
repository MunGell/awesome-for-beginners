...
- [SimpleLearn](https://github.com/skekre98/simple_learn/labels/up-for-grabs) _(label: up-for-grabs)_ <br> A python package built on top of scikit-learn to eliminate the need for math/stat knowledge when developing machine learning models.

...
- [Tensorop](https://github.com/prajjwal1/tensorop) _(label: first-timers-only)_ <br> A unified framwork which provides support for CV/GANs/RL/NLP/DL built over Pytorch

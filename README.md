...
- [Ansible examples](https://github.com/ansible/ansible-examples)_(label: ansible python)_ <br> A few starter examples of ansible playbooks, to show features and how they work together.

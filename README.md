...
- [optimize-images](https://github.com/victordomingos/optimize-images/labels/good%20first%20issue) _(label: good first issue)_  <br> A command-line interface (CLI) utility written in pure Python to help you reduce the file size of images.

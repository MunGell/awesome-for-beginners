...
- [Zulip Chat](https://github.com/zulip/zulip) _(label:Intermediate)_ <br> open source group chat application that combines the immediacy of real-time chat with the productivity benefits of threaded conversations.
## Julia

...
- [Egyptian-Licence-Plate-Detector](https://github.com/zulip/zulip](https://github.com/AymanAzzam/Egyptian-Licence-Plate-Detector) _(label: difficult)_ <br> Image processing open source detects the Egyptian Licence Plate.

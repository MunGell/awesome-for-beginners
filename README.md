...
<!-- ALL ENTRIES SHOULD BE ADDED TO  AND REMOVED FROM the `data.json` -->
...
If you are a maintainer of the open-source projects, add the label `first-timers-only` (or similar) to your project and list it here so that people can find it.

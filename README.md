...
- [Laravel Newsletters](https://github.com/spatie/laravel-newsletter/labels/good%20first%20issue) _(label: beginners-only)_ <br> A package that provides an easy way to integrate MailChimp with Laravel 5.
- [Planning Procurement and Asset Management](https://github.com/cdm4c4lin0/ipams) _(label: good first issue)_ <br> PPMP is an integrated system for every government

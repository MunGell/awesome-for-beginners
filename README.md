...
- [CXXCTP](https://github.com/blockspacer/CXXCTP/labels/good%20first%20issue) _(label: good first issue)_ <br> C++ compile-time programming (serialization, reflection, code modification, extend or parse language)

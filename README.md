...
- [PySimpleGUI](https://github.com/PySimpleGUI/PySimpleGUI/labels/good%20first%20issue) _(label: good first issue)_ <br> Supports tkinter, Qt, WxPython, Remi (in browser). Create custom layout GUI's simply.

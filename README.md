...
- [IronClaw](https://github.com/IronSecCo/ironclaw) _(label: good first issue)_ <br> Security-first, self-hosted AI agents with container isolation you can prove: run untrusted agent code in hardened sandboxes.

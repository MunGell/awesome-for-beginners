...
- [lax.js](https://github.com/alexfoxy/lax.js) _(label: good-first-issue)_ <br> Simple & lightweight vanilla JavaScript library to create smooth & beautiful (<4kb gzipped) animations when you scroll.

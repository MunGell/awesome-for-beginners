...
- [KotlinChessClock](https://github.com/joanb/KotlinChessClock/labels/good%20first%20issue) _(label: good first issue)_ <br> A begginer friendly - open source chess clock for Android

...
- [Genezio](https://github.com/Genez-io/genezio) _(label: good-first-issue)_ <br> A service that comes with a CLI that can deploy your fullstack application (JS/TS/Dart) to [genez.io](https://genez.io)'s infrastructure for free.

...
- [pytesseract](https://github.com/madmaze/pytesseract/labels/good%20first%20issue) _(label: good first issue)_ <br> Python-tesseract is an optical character recognition (OCR) tool for python.

...
- [JS intl Kitchen Sink](https://github.com/xgeekshq/js-intl-kitchen-sink) _(label: good-first-contribution)_ <br> A kitchen sink for the ECMAScript Internationalization API (Intl).
